...
# We use this from within TF to grant explicit access to a logs bucket rather than use a broad storage.rw scope
...
# NOTE: manually restrict access to the gs://${TF_STATE_BUCKET} else any node can pull TF state, which is a serious security flaw!
